...
def launch_setup(context, *args, **kwargs):
    ...
    package_description = "potrol_description_cmake"    
    ...
    #     parameters=[{'frame_prefix': robot_name+'/', 'use_sim_time': True,
...
def generate_launch_description(): 
    ...
    robot_file_arg = DeclareLaunchArgument('robot_file', default_value='potrol.xacro')
